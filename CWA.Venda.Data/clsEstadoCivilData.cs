...
namespace CWA.Venda.Data
{
    public class EstadoCivilData
    {
        ...
        public List<Central.Entity.EstadoCivilCentralEntity> GetLerEstadoCivilCentral()
        {
            try
            {
                ...
                if (DataContext.AbrirConexao())
                {
                    ...
                    myComando.CommandText = "WSP_ESTADOCIVIL";
                    ...
                    if (DataContext.Erro == 0)
                    {
                        ...
                        if (myReader.HasRows)
                        {
                            ...
                            EstadoCivilCentralEntity lEnt;

                            while (myReader.Read())
                            {
                                lEnt = new EstadoCivilCentralEntity();


                                lEnt.NM_ST_ESTADO_CIVIL = myReader[0].ToString();
                                lEnt.ST_ESTADO_CIVIL = int.Parse(myReader[1].ToString());
            ...
            finally
            {
                if (DataContext.ConexaoAberta())
                {
                    ...
                    {
                        _erro = -99;
                        _msgErro = "GetLerEstadoCivilCentral (Select) - Erro ao fechar conexão com o banco de dados.";
                    }
                }
            }
