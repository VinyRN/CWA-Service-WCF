...
{
    public class BancoDebitoBusiness
    {
        ...
        public List<BancoEntity> GetBancoDebitoList(int pintIDProdudo)
        {
            ...
            try
            {
                ...
                lstrParametroMetros = "CWA.EngineServices.InterfaceLoja,GetBancoDebitoList;" + pintIDProdudo.ToString() ;
                ...
                if (lstrRet != "")
                {
                    ...
                    lcolEnt = (List<BancoEntity>)JsonConvert.DeserializeObject(lstrRet, lcolEnt.GetType());
        ...
        public string GetBancoDebitoListService(int pintIDProdudo)
        {

            try
            {

                BancoDebitoData ObjData = new BancoDebitoData();
